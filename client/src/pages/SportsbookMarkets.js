...
const SportsbookMarkets = ({ onRegisterMobileSearch }) => {
  ...
  const MARKETS_BY_SPORT = {
    ...
    americanfootball: [
      ...
      // Quarter Markets
      { key: 'h2h_q1', title: 'Moneyline 1st Quarter', description: '1st quarter win/loss' },
      { key: 'h2h_q2', title: 'Moneyline 2nd Quarter', description: '2nd quarter win/loss' },
      { key: 'h2h_q3', title: 'Moneyline 3rd Quarter', description: '3rd quarter win/loss' },
      { key: 'h2h_q4', title: 'Moneyline 4th Quarter', description: '4th quarter win/loss' },
      { key: 'spreads_q1', title: 'Spreads 1st Quarter', description: '1st quarter point spreads' },
      { key: 'spreads_q2', title: 'Spreads 2nd Quarter', description: '2nd quarter point spreads' },
      { key: 'spreads_q3', title: 'Spreads 3rd Quarter', description: '3rd quarter point spreads' },
      { key: 'spreads_q4', title: 'Spreads 4th Quarter', description: '4th quarter point spreads' },
      { key: 'totals_q1', title: 'Totals 1st Quarter', description: '1st quarter over/under' },
      { key: 'totals_q2', title: 'Totals 2nd Quarter', description: '2nd quarter over/under' },
      { key: 'totals_q3', title: 'Totals 3rd Quarter', description: '3rd quarter over/under' },
      { key: 'totals_q4', title: 'Totals 4th Quarter', description: '4th quarter over/under' },
      // Half Markets
      { key: 'h2h_h1', title: 'Moneyline 1st Half', description: '1st half win/loss' },
      { key: 'h2h_h2', title: 'Moneyline 2nd Half', description: '2nd half win/loss' },
      { key: 'spreads_h1', title: 'Spreads 1st Half', description: '1st half point spreads' },
      { key: 'spreads_h2', title: 'Spreads 2nd Half', description: '2nd half point spreads' },
      { key: 'totals_h1', title: 'Totals 1st Half', description: '1st half over/under' },
      { key: 'totals_h2', title: 'Totals 2nd Half', description: '2nd half over/under' },
      { key: 'team_totals_h1', title: 'Team Totals 1st Half', description: '1st half team totals' },
      { key: 'team_totals_h2', title: 'Team Totals 2nd Half', description: '2nd half team totals' },
      { key: 'team_totals_q1', title: 'Team Totals 1st Quarter', description: '1st quarter team totals' },
      { key: 'team_totals_q2', title: 'Team Totals 2nd Quarter', description: '2nd quarter team totals' },
      { key: 'team_totals_q3', title: 'Team Totals 3rd Quarter', description: '3rd quarter team totals' },
      { key: 'team_totals_q4', title: 'Team Totals 4th Quarter', description: '4th quarter team totals' },
      // Alternate Quarter/Half Markets
      { key: 'alternate_spreads_q1', title: 'Alternate Spreads 1st Quarter', description: 'All 1st quarter spreads' },
      { key: 'alternate_spreads_q2', title: 'Alternate Spreads 2nd Quarter', description: 'All 2nd quarter spreads' },
      { key: 'alternate_spreads_q3', title: 'Alternate Spreads 3rd Quarter', description: 'All 3rd quarter spreads' },
      { key: 'alternate_spreads_q4', title: 'Alternate Spreads 4th Quarter', description: 'All 4th quarter spreads' },
      { key: 'alternate_spreads_h1', title: 'Alternate Spreads 1st Half', description: 'All 1st half spreads' },
      { key: 'alternate_spreads_h2', title: 'Alternate Spreads 2nd Half', description: 'All 2nd half spreads' },
      { key: 'alternate_totals_q1', title: 'Alternate Totals 1st Quarter', description: 'All 1st quarter totals' },
      { key: 'alternate_totals_q2', title: 'Alternate Totals 2nd Quarter', description: 'All 2nd quarter totals' },
      { key: 'alternate_totals_q3', title: 'Alternate Totals 3rd Quarter', description: 'All 3rd quarter totals' },
      { key: 'alternate_totals_q4', title: 'Alternate Totals 4th Quarter', description: 'All 4th quarter totals' },
      { key: 'alternate_totals_h1', title: 'Alternate Totals 1st Half', description: 'All 1st half totals' },
      { key: 'alternate_totals_h2', title: 'Alternate Totals 2nd Half', description: 'All 2nd half totals' },
      { key: 'alternate_team_totals_h1', title: 'Alternate Team Totals 1st Half', description: 'All 1st half team totals' },
      { key: 'alternate_team_totals_h2', title: 'Alternate Team Totals 2nd Half', description: 'All 2nd half team totals' },
      { key: 'alternate_team_totals_q1', title: 'Alternate Team Totals 1st Quarter', description: 'All 1st quarter team totals' },
      { key: 'alternate_team_totals_q2', title: 'Alternate Team Totals 2nd Quarter', description: 'All 2nd quarter team totals' },
      { key: 'alternate_team_totals_q3', title: 'Alternate Team Totals 3rd Quarter', description: 'All 3rd quarter team totals' },
      { key: 'alternate_team_totals_q4', title: 'Alternate Team Totals 4th Quarter', description: 'All 4th quarter team totals' }
    ],
    ...
    baseball: [
      ...
      // Inning Markets
      { key: 'h2h_1st_1_innings', title: 'Moneyline 1st Inning', description: '1st inning win/loss' },
      { key: 'h2h_1st_3_innings', title: 'Moneyline 1st 3 Innings', description: 'First 3 innings win/loss' },
      { key: 'h2h_1st_5_innings', title: 'Moneyline 1st 5 Innings', description: 'First 5 innings win/loss' },
      { key: 'h2h_1st_7_innings', title: 'Moneyline 1st 7 Innings', description: 'First 7 innings win/loss' },
      { key: 'h2h_3_way_1st_1_innings', title: '3-Way Moneyline 1st Inning', description: '1st inning 3-way result' },
      { key: 'h2h_3_way_1st_3_innings', title: '3-Way Moneyline 1st 3 Innings', description: 'First 3 innings 3-way result' },
      { key: 'h2h_3_way_1st_5_innings', title: '3-Way Moneyline 1st 5 Innings', description: 'First 5 innings 3-way result' },
      { key: 'h2h_3_way_1st_7_innings', title: '3-Way Moneyline 1st 7 Innings', description: 'First 7 innings 3-way result' },
      { key: 'spreads_1st_1_innings', title: 'Spreads 1st Inning', description: '1st inning run line' },
      { key: 'spreads_1st_3_innings', title: 'Spreads 1st 3 Innings', description: 'First 3 innings run line' },
      { key: 'spreads_1st_5_innings', title: 'Spreads 1st 5 Innings', description: 'First 5 innings run line' },
      { key: 'spreads_1st_7_innings', title: 'Spreads 1st 7 Innings', description: 'First 7 innings run line' },
      { key: 'totals_1st_1_innings', title: 'Totals 1st Inning', description: '1st inning over/under' },
      { key: 'totals_1st_3_innings', title: 'Totals 1st 3 Innings', description: 'First 3 innings over/under' },
      { key: 'totals_1st_5_innings', title: 'Totals 1st 5 Innings', description: 'First 5 innings over/under' },
      { key: 'totals_1st_7_innings', title: 'Totals 1st 7 Innings', description: 'First 7 innings over/under' },
      // Alternate Inning Markets
      { key: 'alternate_spreads_1st_1_innings', title: 'Alternate Spreads 1st Inning', description: 'All 1st inning run lines' },
      { key: 'alternate_spreads_1st_3_innings', title: 'Alternate Spreads 1st 3 Innings', description: 'All first 3 innings run lines' },
      { key: 'alternate_spreads_1st_5_innings', title: 'Alternate Spreads 1st 5 Innings', description: 'All first 5 innings run lines' },
      { key: 'alternate_spreads_1st_7_innings', title: 'Alternate Spreads 1st 7 Innings', description: 'All first 7 innings run lines' },
      { key: 'alternate_totals_1st_1_innings', title: 'Alternate Totals 1st Inning', description: 'All 1st inning totals' },
      { key: 'alternate_totals_1st_3_innings', title: 'Alternate Totals 1st 3 Innings', description: 'All first 3 innings totals' },
      { key: 'alternate_totals_1st_5_innings', title: 'Alternate Totals 1st 5 Innings', description: 'All first 5 innings totals' },
      { key: 'alternate_totals_1st_7_innings', title: 'Alternate Totals 1st 7 Innings', description: 'All first 7 innings totals' }
    ],
    // Hockey (NHL)
    hockey: [
      { key: 'h2h', title: 'Moneyline', description: 'Win/Loss bets' },
      ...
      // Period Markets
      { key: 'h2h_p1', title: 'Moneyline 1st Period', description: '1st period win/loss' },
      { key: 'h2h_p2', title: 'Moneyline 2nd Period', description: '2nd period win/loss' },
      { key: 'h2h_p3', title: 'Moneyline 3rd Period', description: '3rd period win/loss' },
      { key: 'h2h_3_way_p1', title: '3-Way Moneyline 1st Period', description: '1st period 3-way result' },
      { key: 'h2h_3_way_p2', title: '3-Way Moneyline 2nd Period', description: '2nd period 3-way result' },
      { key: 'h2h_3_way_p3', title: '3-Way Moneyline 3rd Period', description: '3rd period 3-way result' },
      { key: 'spreads_p1', title: 'Spreads 1st Period', description: '1st period puck line' },
      { key: 'spreads_p2', title: 'Spreads 2nd Period', description: '2nd period puck line' },
      { key: 'spreads_p3', title: 'Spreads 3rd Period', description: '3rd period puck line' },
      { key: 'totals_p1', title: 'Totals 1st Period', description: '1st period over/under' },
      { key: 'totals_p2', title: 'Totals 2nd Period', description: '2nd period over/under' },
      { key: 'totals_p3', title: 'Totals 3rd Period', description: '3rd period over/under' },
      { key: 'team_totals_p1', title: 'Team Totals 1st Period', description: '1st period team goals' },
      { key: 'team_totals_p2', title: 'Team Totals 2nd Period', description: '2nd period team goals' },
      { key: 'team_totals_p3', title: 'Team Totals 3rd Period', description: '3rd period team goals' },
      // Alternate Period Markets
      { key: 'alternate_spreads_p1', title: 'Alternate Spreads 1st Period', description: 'All 1st period puck lines' },
      { key: 'alternate_spreads_p2', title: 'Alternate Spreads 2nd Period', description: 'All 2nd period puck lines' },
      { key: 'alternate_spreads_p3', title: 'Alternate Spreads 3rd Period', description: 'All 3rd period puck lines' },
      { key: 'alternate_totals_p1', title: 'Alternate Totals 1st Period', description: 'All 1st period totals' },
      { key: 'alternate_totals_p2', title: 'Alternate Totals 2nd Period', description: 'All 2nd period totals' },
      { key: 'alternate_totals_p3', title: 'Alternate Totals 3rd Period', description: 'All 3rd period totals' },
      { key: 'alternate_team_totals_p1', title: 'Alternate Team Totals 1st Period', description: 'All 1st period team totals' },
      { key: 'alternate_team_totals_p2', title: 'Alternate Team Totals 2nd Period', description: 'All 2nd period team totals' },
      { key: 'alternate_team_totals_p3', title: 'Alternate Team Totals 3rd Period', description: 'All 3rd period team totals' }
    ],
    // Soccer (EPL, MLS, etc.)
    soccer: [
      { key: 'h2h', title: 'Moneyline', description: 'Win/Loss bets' },
