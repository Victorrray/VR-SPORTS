    ...
    <div className="space-y-6">
      ...
      {isFilterMenuOpen && (
        <>
          ...
          >
            {/* Sticky Header */}
            <div className={`sticky top-0 ${isLight ? 'bg-white border-gray-200' : 'bg-slate-900 border-purple-400/50'} z-10 px-6 pt-6 lg:pt-20 pb-4 space-y-4 lg:border-b border-b-0 -mt-6 lg:rounded-none max-lg:rounded-t-2xl`}>
