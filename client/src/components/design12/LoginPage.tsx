                ...
                <div className="relative space-y-6">
                  ...
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-white/50 font-medium">
                      {isLogin ? 'Sign in to access your dashboard' : 'Start finding +EV bets today'}
                    </p>
                  </div>
                  ...
                  {/* Tab Toggle */}
                  <div className="flex gap-2 p-1.5 bg-slate-950/50 rounded-2xl border border-white/10">
                    <motion.button
                    ...
                    {isLogin && (
                      <div className="flex items-center justify-between text-sm">
                        <label className="flex items-center gap-2 cursor-pointer group">
                          <input
                            type="checkbox"
                            className="w-4 h-4 rounded bg-slate-950/50 border border-white/20 text-purple-500 focus:outline-none focus:ring-0"
                          />
                          <span className="text-white/60 group-hover:text-white/80 font-medium transition-colors">
                            Remember me
                          </span>
                        </label>
                        <button
