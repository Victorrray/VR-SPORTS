              ...
              <div className="relative space-y-4 md:space-y-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2.5 md:gap-3 px-3.5 md:px-4 py-3 md:py-3.5 bg-slate-950/50 border border-white/10 rounded-lg md:rounded-xl text-white/90 hover:bg-slate-900/70 hover:border-white/20 transition-all font-bold text-sm md:text-base disabled:opacity-50 disabled:cursor-not-allowed"
                  >
