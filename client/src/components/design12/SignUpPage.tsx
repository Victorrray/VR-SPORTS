      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="w-full max-w-md mx-auto lg:mx-0">
            ...
            <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-slate-900/80 to-purple-900/30 backdrop-blur-xl border border-white/10 p-8 md:p-10 shadow-2xl">
              ...
              <div className="relative space-y-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="••••••••"
                        className="w-full px-4 py-3.5 bg-slate-950/50 border border-white/10 rounded-md text-white placeholder:text-white/30 focus:outline-none focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 transition-all font-semibold pr-12"
                        required
                      />
                      <button
                        type="button"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-purple-500 to-indigo-500 text-white py-4 rounded-md hover:from-purple-400 hover:to-indigo-400 transition-all font-bold shadow-lg shadow-purple-500/30 text-center"
                  >
                    Create your account
                  </button>
                  ...
                  <button
                    type="button"
                    className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-slate-950/50 border border-white/10 rounded-md text-white/90 hover:bg-slate-900/70 hover:border-white/20 transition-all font-bold"
                  >
