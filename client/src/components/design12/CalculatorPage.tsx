      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className={`${isLight ? 'bg-white border-gray-200 shadow-sm' : 'bg-gradient-to-br from-white/[0.08] to-white/[0.02] border-white/10'} backdrop-blur-2xl border rounded-2xl p-6`}>
          <div className="flex items-center gap-3 mb-5">
            <div className={`w-8 h-8 rounded-xl flex items-center justify-center ${isLight ? 'bg-blue-100' : 'bg-blue-500/20'}`}>
        ...
        <div className={`${isLight ? 'bg-white border-gray-200 shadow-sm' : 'bg-gradient-to-br from-white/[0.08] to-white/[0.02] border-white/10'} backdrop-blur-2xl border rounded-2xl p-6`}>
          <div className="flex items-center gap-3 mb-5">
            <div className={`w-8 h-8 rounded-xl flex items-center justify-center ${isLight ? 'bg-emerald-100' : 'bg-emerald-500/20'}`}>
