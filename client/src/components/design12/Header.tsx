      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20 md:h-24">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button className="px-6 py-2.5 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-md hover:from-purple-600 hover:to-indigo-600 transition-all font-semibold">
              Sign up
            </button>
          </div>
          ...
          <div className="md:hidden">
            <nav className="flex flex-col gap-3 px-6 py-6 bg-gradient-to-br from-slate-900/95 via-slate-900/98 to-slate-950/95 backdrop-blur-2xl border-t border-white/10 rounded-b-2xl">
              ...
              <div className="flex flex-col gap-3 mt-4 pt-4 border-t border-white/10">
                ...
                <button className="w-full px-6 py-2.5 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-md hover:from-purple-400 hover:to-indigo-400 transition-all font-bold border border-purple-400/30">
                  Sign up
                </button>
              </div>
            </nav>
