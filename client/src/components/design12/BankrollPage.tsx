      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`px-4 py-2.5 ${isLight ? 'bg-purple-100 text-purple-700 border-purple-300 hover:bg-purple-200' : 'bg-purple-500/20 border-purple-400/30 text-white hover:bg-purple-500/40'} backdrop-blur-xl border rounded-xl transition-all font-bold text-sm flex items-center gap-2 whitespace-nowrap`}
          >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className={`p-5 ${isLight ? lightModeColors.statsCard : 'bg-gradient-to-br from-white/5 via-white/[0.02] to-transparent border-white/10'} backdrop-blur-2xl border rounded-2xl`}>
          <div className="flex items-center gap-3 mb-3">
            <div className={`p-2 ${isLight ? 'bg-purple-100 border-purple-200' : 'bg-purple-500/20 border-purple-400/30'} backdrop-blur-xl rounded-xl border`}>
