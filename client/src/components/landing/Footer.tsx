        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-8 md:mb-12">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://twitter.com/oddsightseer" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full flex items-center justify-center transition-all">
                <Twitter className="w-4 h-4 text-white/60" />
              </a>
              <a href="mailto:support@oddsightseer.com" className="w-9 h-9 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full flex items-center justify-center transition-all">
