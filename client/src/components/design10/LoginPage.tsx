      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="w-full max-w-md mx-auto lg:mx-0">
            ...
            <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-gradient-to-br from-slate-900/80 to-purple-900/30 backdrop-blur-xl border border-white/10 p-5 md:p-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
                  ...
                  <div className="space-y-1.5 md:space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-3.5 md:px-4 py-3 md:py-3.5 bg-slate-950/50 border border-white/10 rounded-lg md:rounded-xl text-white placeholder:text-white/30 focus:outline-none focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 transition-all font-semibold text-sm md:text-base"
                      required
                    />
                  </div>
                  ...
                  <div className="space-y-1.5 md:space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="••••••••"
                        className="w-full px-3.5 md:px-4 py-3 md:py-3.5 bg-slate-950/50 border border-white/10 rounded-lg md:rounded-xl text-white placeholder:text-white/30 focus:outline-none focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 transition-all font-semibold pr-11 md:pr-12 text-sm md:text-base"
                        required
                      />
                      <button
                        type="button"
                  ...
                  {isLogin && (
                    <div className="flex items-center justify-between text-xs md:text-sm">
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <input
                          type="checkbox"
                          className="w-3.5 h-3.5 md:w-4 md:h-4 rounded bg-slate-950/50 border-white/20 text-purple-500 focus:ring-2 focus:ring-purple-500/50"
                        />
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-gradient-to-r from-purple-500 to-indigo-500 text-white py-3.5 md:py-4 rounded-lg md:rounded-xl hover:from-purple-400 hover:to-indigo-400 transition-all font-bold text-center text-sm md:text-base disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <button
                    type="button"
                    className="w-full flex items-center justify-center gap-2.5 md:gap-3 px-3.5 md:px-4 py-3 md:py-3.5 bg-slate-950/50 border border-white/10 rounded-lg md:rounded-xl text-white/90 hover:bg-slate-900/70 hover:border-white/20 transition-all font-bold text-sm md:text-base"
                  >
