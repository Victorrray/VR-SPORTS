...
export default function SEOHead({ 
  title = "OddsSightSeer - Smart Sports Betting Analytics",
  ...
  const fullTitle = title.includes('OddsSightSeer') ? title : `${title} | OddsSightSeer`;
  ...
  return (
    <Helmet>
      ...
      <meta name="author" content="OddsSightSeer" />
      ...
      <meta property="og:site_name" content="OddsSightSeer" />
