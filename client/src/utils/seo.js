...
export const SITE_CONFIG = {
  ...
  description: 'Odds comparison tool to find the best NFL, NBA & MLB lines. Compare DraftKings vs FanDuel odds, find +EV player props, and shop lines across 15+ sportsbooks.',
  keywords: 'DraftKings vs FanDuel odds, best NFL betting odds today, NBA player props comparison, odds comparison tool, PrizePicks vs Underdog lines, best sportsbook for NFL, line shopping tool, positive EV bets finder, NFL spreads comparison, NBA totals best odds, MLB moneyline comparison, same game parlay odds, live betting odds comparison, best odds for Super Bowl, March Madness betting odds',
...
export const PAGE_TITLES = {
  home: 'Odds Comparison Tool — DraftKings vs FanDuel & More',
...
export const PAGE_DESCRIPTIONS = {
  home: 'Compare DraftKings, FanDuel, BetMGM & 12+ sportsbook odds. Find the best NFL, NBA, MLB lines and +EV player props in seconds.',
  ...
  pricing: 'Compare odds across 15+ sportsbooks. Choose Gold or Platinum for player props, unlimited access, and advanced analytics.',
  ...
  signup: 'Create an account to compare odds across 15+ sportsbooks, track your bets, and find +EV opportunities.',
