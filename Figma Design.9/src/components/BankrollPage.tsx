import { Wallet, TrendingUp, TrendingDown, DollarSign, Plus, Minus, Target, AlertCircle, Calendar, ArrowUpRight, ArrowDownRight, Activity, Settings } from 'lucide-react';
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="hidden md:inline">Set Bankroll</span>
          </button>
          <button
