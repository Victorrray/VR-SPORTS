        ...
        <div className="bg-slate-950/60 backdrop-blur-xl border border-white/10 rounded-full px-4 md:px-6 py-3 shadow-lg shadow-purple-500/10">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-2">
              ...
              <button className="ml-2 px-5 py-2.5 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-full hover:from-purple-400 hover:to-indigo-400 transition-all shadow-lg shadow-purple-500/30 backdrop-blur-sm border border-purple-400/20 text-sm font-semibold">
                Get Started →
              </button>
            </nav>
        ...
        {isMenuOpen && (
          <nav className="lg:hidden mt-2 bg-slate-950/60 backdrop-blur-xl border border-white/10 rounded-3xl p-4 shadow-lg shadow-purple-500/10">
            <div className="flex flex-col gap-2">
              ...
              <button className="mt-2 px-5 py-2.5 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-full hover:from-purple-400 hover:to-indigo-400 transition-all shadow-lg shadow-purple-500/30 text-sm font-semibold">
                Get Started →
              </button>
            </div>
          </nav>
