      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-5xl mx-auto">
              ...
              return (
                <div key={idx} className="relative">
                  ...
                  <div className="relative group">
                    {/* Card */}
                    <div className={`bg-gradient-to-br ${step.gradient} rounded-2xl md:rounded-3xl p-6 md:p-8 hover:shadow-2xl transition-all duration-300`}>
                      {/* Step Number Badge */}
                      <div className="absolute -top-4 -right-4 w-12 h-12 md:w-14 md:h-14 bg-white rounded-full flex items-center justify-center shadow-lg border-4 border-gray-900">
          ...
          <div className="mt-12 md:mt-16 text-center">
            <button className="group px-8 py-4 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-full hover:from-purple-600 hover:to-indigo-600 transition-all shadow-[0_20px_50px_rgba(168,85,247,0.3)] hover:shadow-[0_25px_60px_rgba(168,85,247,0.4)] font-bold inline-flex items-center gap-2">
