  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50">
      <div className="container mx-auto px-4">
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden pb-6 bg-slate-950/95 backdrop-blur-xl border-t border-white/10 rounded-b-2xl">
            <nav className="flex flex-col gap-4 px-4 py-6">
              ...
              <button 
                onClick={onDashboardClick}
                className="w-full px-6 py-2.5 text-white border border-white/20 rounded-lg hover:bg-white/5 transition-all font-medium"
              >
                Dashboard
              </button>
              <a href="#pricing" className="text-white/70 hover:text-white transition-colors font-medium">
              ...
              <div className="flex flex-col gap-3 mt-4">
                ...
                <button className="w-full px-6 py-2.5 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-lg hover:from-purple-600 hover:to-indigo-600 transition-all font-semibold">
                  Sign up
                </button>
              </div>
            </nav>
