-- UNIFIED VR-ODDS SUBSCRIPTION TRACKING
-- This script works with your existing profiles table structure
-- Run this AFTER your existing schema upgrade
...
DO $$
BEGIN
  RAISE NOTICE '✅ Unified subscription tracking completed!';
  ...
  RAISE NOTICE '- Server compatibility via users view';
END $$;
